...
class EventDatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_date" do
    assert_difference('EventDate.count') do
      post event_dates_url, params: { event_date: { index: @event_date.index, show: @event_date.show } }
    end
  ...
  test "should update event_date" do
    patch event_date_url(@event_date), params: { event_date: { index: @event_date.index, show: @event_date.show } }
