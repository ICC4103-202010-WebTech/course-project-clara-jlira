...
class EventFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_file" do
    assert_difference('EventFile.count') do
      post event_files_url, params: { event_file: { index: @event_file.index, show: @event_file.show } }
    end
  ...
  test "should update event_file" do
    patch event_file_url(@event_file), params: { event_file: { index: @event_file.index, show: @event_file.show } }
