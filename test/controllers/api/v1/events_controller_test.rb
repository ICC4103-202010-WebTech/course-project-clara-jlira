...
class Api::V1::EventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_event" do
    assert_difference('Api::V1::Event.count') do
      post api_v1_events_url, params: { api_v1_event: { index: @api_v1_event.index, show: @api_v1_event.show } }
    end
  ...
  test "should update api_v1_event" do
    patch api_v1_event_url(@api_v1_event), params: { api_v1_event: { index: @api_v1_event.index, show: @api_v1_event.show } }
